package umn.ac.id.week07b_28896;
...
public class DaftarVideoAdapter extends
    ...
    class ItemVideoViewHolder extends RecyclerView.ViewHolder
        ...
        public void onClick(View v){
            ...
            Intent detilIntent = new Intent(mContext, DetilVideoActivity.class);
            Bundle bundle = new Bundle();
            bundle.putSerializable("DetilVideo",mSumberVideo);
            detilIntent.putExtras(bundle);
            mContext.startActivity(detilIntent);
        }
    }
}
